...
function App() {
  ...
  const handleNextCard = () => {
    const nextIndex = Math.floor(Math.random() * celebrityData.length);
  ...
  return (
    <div className="App">
      <div className="container">
        ...
        <p className="description">How well do you know your Hollywood stars? Test your knowledge here!</p>
        <p className="celebrity-count">Number of celebrities: {celebrityData.length}</p>
        ...
        <button onClick={handleNextCard}>Next Celebrity</button>
      </div>
    </div>
  );
}
